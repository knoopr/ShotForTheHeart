"""
Django settings for ShotForTheHeart project.
...
SECRET_KEY = 'ij@skt-m+2ks-9j-s%ik+$rst-6^6y^dkergk-rv)erba_qh$p'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["shotfortheheart.ca", "www.shotfortheheart.ca"]
...
ROOT_URLCONF = 'ShotForTheHeart.urls'
...
WSGI_APPLICATION = 'ShotForTheHeart.wsgi.application'
